...
**Your Answers here:**
* [Exchange Rates](https://github.com/RunOpenCode/exchange-rate)
* [Data on Derivatives](https://github.com/imanuelcostigan/dataonderivatives)
...
**Your Answers here:**
<br>
1. The Apple returns are requested in line 8, along with the SPY. The comments also give examples of other tickers that can be given.
<br>
2. What are the cumulative, average daily returns, and the standard deviation of the daily returns of Apple in the same period? They are the sum, the results of the function, and standard deviation is the variance of the daily data, respectively.
<br>
3. As mentioned in Q1, you could simply enter the ticker symbol for that company in addition to AAPL
<br>
...
**Your Answers here:**
<br>
1. After defining transposedData, use nrow() and ncol() functions
<br>
2. 
<br>
...
**Your Answers here:**
<br>
1. Change the call to 2001-01-01 from 2005-01-01, the original input
<br>
2. 
<br>
<br>
